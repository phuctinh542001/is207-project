...
<main id="main">
    ...
    <div class="container-fluid">
        <div id="page__signup">
           <h1>Đăng ký</h1>
            <form class="page__signup--info" method="post" action="{{route('sign-up')}}">
                <input type="hidden" name="_token" value="{{csrf_token()}}">

                <label class="signup__item">Tên đăng nhập:</label>
                <input class="page__signup--input" type="text" name="username">

                <label class="signup__item">Email:</label>
                <input class="page__signup--input" type="text" name="email">

                <label class="signup__item">Mật khẩu:</label>
                <input class="page__signup--input" type="password" name="password">

                <label class="signup__item">Nhập lại mật khẩu:</label>
                <input class="page__signup--input" type="password" name="re_password">

                <input class="btn--submit" type="submit" name="signup" value="Đăng ký">
            </form>
        </div>
        @if(count($errors) > 0)
